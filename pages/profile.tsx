...
import { IconUpload, IconPhoto, IconX,  IconMessageForward, IconBookDownload } from '@tabler/icons-react';
        ...
        <div className="flex bg-beige w-full justify-center flex-col ">
            <div className=" bg-white mt-10 rounded-lg mx-72 pb-6 -mb-5">
                <div className="w-full bg-[url('./../images/profile.png')] bg-cover h-1/2 pt-48 pb-5">                
                 ...
                 <div className="flex justify-end my-8 mx-8">
                  <button onClick={handlers1.open}><Image src={edit} alt="edit pen image" className=" h-7 w-7 "/></button>
                  <Modal opened={opened} onClose={handlers1.close} title="Edit Profile" size="70%">
                  <Box my={"xl"}>
                    ...
                    <SimpleGrid cols={7} spacing="xl" className="mt-7" >
                        ...
                        <div >
                            <Modal opened={opened2} onClose={handlers2.close} size="50%" >
                             <Title order={3} className="mb-7">Add Profile Section</Title>
                             <Modal opened={opened3} onClose={handlers3.close} className="p-80" centered>
                             <Dropzone
                            ...
                            <Link href="#" onClick={handlers3.open}><div className="text-gray-500"><p>Add Profile Photo</p></div></Link>
                            <Divider my="sm" />
                            <Link href="#"><div className="text-gray-500"><p>Add Education</p></div></Link>
                            <Divider my="sm" />
                            <Link href="#"><div className="text-gray-500"><p>Add Position</p></div></Link>
                            <Divider my="sm" />
                            <Link href="#"><div className="text-gray-500"><p>Add Career Break</p></div></Link>
                            <Divider my="sm" />
                            <Link href="#"><div className="text-gray-500"><p>Add Profile Photo</p></div></Link>
                            <Divider my="sm" />
                            <Link href="#"><div className="text-gray-500"><p>Add Skills</p></div></Link>
                            <Divider my="sm" />                            
                            <Link href="#"><div className="text-gray-500"><p>Add Awards</p></div></Link>
                            <Divider my="sm" />
                            <Link href="#"><div className="text-gray-500"><p>Add Projects</p></div></Link>
                            <Divider my="sm"  className="mb-12"/>
                            </Modal>
                            <Button color="red" variant="outline" className=" text-md rounded-3xl" onClick={handlers2.open}>Add Profile Section</Button>
                        </div>
                        <div>
                            <Menu>
                                <Menu.Target>
           ...
           <div className="bg-white mt-10 rounded-lg mx-72 pb-6  -mb-5">
                <div className=" ml-10 mt-7 text-justify pr-7">
                    <Title order={3} className="font-josefin mb-2 ">About</Title>

                    <p className= "">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere sapien quis ante ultrices tempus. Ut et ante mauris. Proin tincidunt finibus metus. Aliquam erat volutpat. Donec est odio, suscipit id molestie vitae, ultricies eu nunc. Etiam turpis erat, scelerisque vel ornare vel, bibendum a nisl. 
                        Duis sit amet dolor nisl. Pellentesque vitae erat aliquam, elementum enim sed, dignissim elit. 
                        Praesent ante sem, tempor eu velit et, ornare euismod eros. 
                    </p>
                </div>            
           </div>
           <div className="bg-white mt-10 rounded-lg mx-72 pb-6  -mb-5">
                <div className=" ml-10 mt-7 text-justify pr-7">
                    <Title order={3} className="font-josefin mb-2 ">Education</Title>
           ...
           <div className="bg-white mt-10 rounded-lg mx-72 pb-6 -mb-5">
                <div className=" ml-10 mt-7 text-justify pr-7">
                    <Title order={3} className="font-josefin mb-2 ">Skills</Title>
           ...
           <div className="bg-white mt-10 rounded-lg mx-72 pb-6 mb-9">
                <div className=" ml-10 mt-7 text-justify pr-7">
                    <Title order={3} className="font-josefin mb-2 ">Interests</Title>
