      ...
      <div className="bg-white flex flex-row h-screen">
        ...
        <div className=" pl-10 w-2/3 pr-20 bg-beige pb-5 overflow-y-scroll">
          ...
          <p className="text-justify mb-8">
            ...
            purus velit, eleifend at aliquet vel, suscipit at urna. Curabitur
            eget mi eget lectus lacinia placerat ac in enim. Phasellus porttitor
            lorem imperdiet, lobortis felis in, varius quam. Vestibulum
            fermentum turpis at tellus lobortis luctus. Ut at condimentum nibh,
            eget posuere lorem. Nulla vestibulum, metus ac laoreet fermentum,
            nulla lectus faucibus elit, ac ornare nisi ipsum et ante. Nulla
            pretium pellentesque fringilla.`}
          </p>
        </div>
      </div>
    </>
